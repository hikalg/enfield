from enfield.settings import settings as EnfieldSettings
...
class BasePlayer(BaseEntity):
    ...
    player_rating : PositiveInt = Field(default=EnfieldSettings.player_default_rating)
    
    player_match_count : PositiveInt = Field(default=EnfieldSettings.player_default_match_count)
    
    player_win_count : PositiveInt = Field(default=EnfieldSettings.player_default_win_count)
    ...
    def override_rating(self, value: StrictInt = 0):
        if value == 0:
            ...
            self.player_rating = EnfieldSettings.player_default_rating
